...
groups=()
depends=()
makedepends=('astyle' 'cmake' 'gcc' 'ninja' 'openssl' 'python-pytest' 'python-pytest-xdist' 'unzip' 'libxslt' 'doxygen' 'graphviz' 'python-yaml' 'valgrind')
